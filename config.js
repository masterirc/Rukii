...
module.exports = {
    VERSION: 'Ruki v1 - Public Stable',
    SESSION: process.env.AMDI_SESSION === undefined ? '' : process.env.AMDI_SESSION,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    AFKMSG: process.env.AFK_MESSAGE === undefined ? 'default' : process.env.AFK_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/t30zRG3/Rukii-Logo.jpg' : process.env.ALIVE_LOGO,
    ...
    BYE_LOGO: process.env.BYE_LOGO === undefined ? 'https://i.ibb.co/t30zRG3/Rukii-Logo.jpg' : process.env.BYE_LOGO,
    CAP: process.env.CAP === undefined ? '↫𝓼𝓴𝔂7↬⦁ᖇᑌKIIᴾʳᵒᵈᵘᶜᵗⁱᵒⁿ⦁↫𝓼𝓴𝔂7↬' : process.env.CAP,
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/t30zRG3/Rukii-Logo.jpg' : process.env.GAN_IMAGE,
    ...
    WELCOME_LOGO: process.env.WELCOME_LOGO === undefined ? 'https://i.ibb.co/t30zRG3/Rukii-Logo.jpg' : process.env.WELCOME_LOGO,
